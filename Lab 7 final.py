...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov  9 22:25:59 2022
...
#Writing the students' names and the total amount they owned to the new file
for i in range(len(total_amount_list)):
    print(student_list[i]+" "+str(round(total_amount_list[i],2)))
    if i==0:
